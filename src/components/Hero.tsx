    ...
    <section className="relative min-h-screen pt-20 overflow-hidden animate-section">
      ...
      <div className="relative container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-2xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-full mb-6 animate-fade-up">
            <Building2 className="w-4 h-4 text-white" />
            <span className="text-sm font-medium text-white">Trusted Corporate Cafeteria Partner in Gurugram</span>
          </div>

          {/* Headline */}
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            Your Complete{" "}
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-black/80 mb-8 animate-fade-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="grid grid-cols-3 gap-6 animate-fade-up" style={{ animationDelay: "0.4s" }}>
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                ...
                <span className="font-display text-2xl md:text-3xl font-bold text-black">100+</span>
              </div>
              <p className="text-sm text-black/60">Office Cafeterias</p>
            </div>
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                <Users className="w-5 h-5 text-primary" />
                <span className="font-display text-2xl md:text-3xl font-bold text-black">5000+</span>
              </div>
              <p className="text-sm text-black/60">Employees Served Daily</p>
            </div>
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                <Clock className="w-5 h-5 text-primary" />
                <span className="font-display text-2xl md:text-3xl font-bold text-black">10+</span>
              </div>
